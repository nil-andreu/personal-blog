...
function Cloud() {
  ...
  const counts: number[] = [1, 2, 4, 5, 4, 2, 1];
   ...
   */
  function wordSphere(canvas: HTMLCanvasElement, texts: string[], counts: number[], options: { [key: string]: number }) {
